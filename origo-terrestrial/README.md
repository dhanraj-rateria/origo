...
The ground-side PQC HSM module — a **software stand-in** for firmware that doesn't
exist yet, co-located with `origo-station-agent` on the same physical hardware in the
design. Design reference: [`PQC-HSM-Design.md`](PQC-HSM-Design.md) §1, §5.2, §7.
